                ...
                <div class="page-inner">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="<?= PARTNER_URL . '/orders' ?>">Đặt xe</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="<?= PARTNER_URL . '/orders' ?>" class="btn btn-primary btn-round ml-auto">
                                            Danh sách
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="invoice col-md-12 p-3 mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form method="post" action="<?php echo PARTNER_URL . '/orders/save-edit' ?>" enctype="multipart/form-data">
                                                        <div class="card-body">
